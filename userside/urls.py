...
urlpatterns = [
    ...
    path('property_type1/<str:property_status>', views.property_type1, name='property-type1'),
    path('property_type2/<str:property_type>', views.property_type2, name='property_type2'),
    ...
    path('property_type/property_type_filter', views.property_type_filter, name='property_type_filter'),
    path('property_type/property_type_filter', views.property_type_filter, name='property_type_filter'),
